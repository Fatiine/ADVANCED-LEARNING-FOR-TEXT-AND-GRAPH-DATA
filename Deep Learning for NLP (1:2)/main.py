...
word_vectors.intersect_word2vec_format(path_to_word2vec + 'GoogleNews-vectors-negative300.bin', binary=True)
...
doc_wv = Embedding(input_dim=embeddings_pca.shape[0], #vocab size
