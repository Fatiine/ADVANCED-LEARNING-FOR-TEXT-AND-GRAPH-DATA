...
all_terms = [item for sublist in terms_by_doc for item in sublist]
...
collection_degrees = dict(zip(c_g.vs['name'], c_g.strength()))
...
classifiers = [classifier_degree,classifier_w_degree,classifier_closeness,classifier_w_closeness,classifier_twicw,classifier_tfidf]
i = 1
